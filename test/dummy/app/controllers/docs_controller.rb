...
class DocsController < ApplicationController
  ...
  def gem_views
    prefix = "#{RecordingStudioSiteSettings::Engine.root}/"

    @engine_views = Dir.glob(RecordingStudioSiteSettings::Engine.root.join("app/views/recording_studio_site_settings/**/*.erb").to_s)
      .sort
