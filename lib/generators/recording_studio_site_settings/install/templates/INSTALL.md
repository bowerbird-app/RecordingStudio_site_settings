...
1. Review config/initializers/recording_studio_site_settings.rb and set any required options.
2. If you use environment-specific settings, create config/recording_studio_site_settings.yml.
3. Install the engine migrations with `bin/rails generate recording_studio_site_settings:migrations`.
