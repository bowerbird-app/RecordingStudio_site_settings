...
- This repository is the Recording Studio Site Settings addon. It is the source of truth for a site's name and logo.
...
- Do not store name or logo on Recording Studio core or on the site root recordable.
